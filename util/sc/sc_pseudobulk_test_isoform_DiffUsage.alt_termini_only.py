...
def main():
    ...
    args.ignore_unspliced = True  # Note - code currently only works for spliced isoforms given it groups on splice hashcode.  TODO:// extend logic to single exon transcripts
    ...
    for i in range(len(cluster_names)):
        ...
        for j in range(i + 1, len(cluster_names)):
            ...
            test_df_results = differential_isoform_tests(
                df=test_df,
                group_by_token="splice_hashcode",
