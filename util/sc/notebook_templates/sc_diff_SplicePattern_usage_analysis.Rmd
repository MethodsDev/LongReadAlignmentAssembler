...
sample_name = "cordblood_LRAA"

sparse_matrix_data_dir = "../Cordblood-sc-guided^splice_pattern-sparseM/"

umap_cluster_file = "../DE_gene_analysis_using_Illumina_clusters/Cordblood-sc-guided.genes-Illum-cell_cluster_assignments.wUMAP.tsv"

cluster_pseudobulk_matrix_filename = "LRAA.illum_clusters.pseudobulked.matrix"

gtf_filename = "../cordblood.LRAA.sc_merged.gtf.updated.sp_collapsed.segmented.gtf"

diff_iso_usage_stats_filename = "LRAA.Cordblood-sc-guided^splice_pattern.top_only_w_recip_delta_pi.diff_iso.tsv.signif_only"
...
my_gene_of_interest = "ANXA3^g:chr4:+:comp-458"
...
umap_df = umap_df %>% rename(seurat_clusters = custom_clusters)
...
test_gene = "ANXA3^g:chr4:+:comp-458"

test_plot_info = get_expression_ggplot2_heatmap_w_exon_structures(test_gene, 0.2, ignore_unspliced=T)
test_plot_info$plot
