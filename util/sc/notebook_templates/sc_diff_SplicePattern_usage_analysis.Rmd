...
get_isoform_umap = function(gene_of_interest) {
...
plot_isoform_umap = function(gene_of_interest) {
  
  isoform_umap = get_isoform_umap(gene_of_interest)
...
get_expression_pheatmap_w_exon_structures = function(gene_of_interest) {
  ...
  isoform_expr = cluster_counts_matrix[rownames(cluster_counts_matrix) %in% transcript_ids,]
...
get_expression_ggplot2_heatmap_w_exon_structures = function(gene_of_interest) {
...
p_exon_expr = get_expression_ggplot2_heatmap_w_exon_structures(my_gene_of_interest)
...
p_umap = plot_isoform_umap(my_gene_of_interest)
...
make_diff_iso_usage_compound_plot = function(gene_of_interest) {
...
p_my_gene_of_interest = make_diff_iso_usage_compound_plot(my_gene_of_interest)
...
top_diff_iso_usage_plots_dir <- paste0("top_", num_top_diff_iso_usage_plots, "_diff_iso_usage_plots")
...
for(gene_sym_value in top_diff_iso_usage_genes) {
    ...
    p = make_diff_iso_usage_compound_plot(gene_sym_value_regex)
    plot(p)
    dev.off()
}  
