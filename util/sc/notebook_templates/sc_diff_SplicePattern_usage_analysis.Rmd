...
sample_name = "PBMCs_LRAA"

sparse_matrix_data_dir = "../LRAA_sc_PBMCs^splice_pattern-sparseM/"

umap_cluster_file = "../LRAA_sc_PBMCs.genes-cell_cluster_assignments.wUMAP.wCAS.tsv"

cluster_pseudobulk_matrix_filename = "LRAA.pbmc.splicepatterns.cluster_pseudobulks.matrix"

gtf_filename = "../PBMCs_pbio.LRAA.sc_merged.gtf.updated.splice_collapsed.segmented.gtf"

diff_iso_usage_stats_filename = "LRAA.pbmc.splicepatterns.top_only_w_recip_delta_pi.diff_iso.tsv.signif_only"
...
my_gene_of_interest = "ADCY9^g:chr16:-:comp-633"
...
counter = 0
for(gene_sym_value in top_diff_iso_usage_genes$gene_id) {
