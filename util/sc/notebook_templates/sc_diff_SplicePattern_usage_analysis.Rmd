...
sample_name = "LP00714_by_SP"

sparse_matrix_data_dir = "../../LP00714-sc-guided^splice_pattern-sparseM/"

umap_cluster_file = "../LP00714-sc-guided-MtFiltNregressed.genes-cell_cluster_assignments.wSTMN2info.wMeta.tsv"

cluster_pseudobulk_matrix_filename = "../LP00714-sc-guided-MtFiltNregressed.cluster_pseudobulk.matrix"

gtf_filename = "../../LP00714.LRAA.sc_merged.gtf.updated.SP_collapsed.segmented.gtf"

#diff_iso_usage_stats_filename = "LP00714-sc-guided-MtFiltNregressed.cluster_pseudobulk.matrix.cluster_pseudobulk.matrix.IGNORE_UNSPLICED_for_diff_iso_usage.diff_iso.chi2.signif.tsv"


#diff_iso_usage_stats_filename = "LP00714-sc-guided-MtFiltNregressed.cluster_pseudobulk.matrix.cluster_pseudobulk.matrix.IGNORE_UNSPLICED_TOP_ISO_EACH_for_diff_iso_usage.diff_iso.chi2.tsv"


diff_iso_usage_stats_filename = "LP00714-sc-guided-MtFiltNregressed.cluster_pseudobulk.matrix.cluster_pseudobulk.matrix.IGNORE_UNSPLICED_TOP_ISO_EACH_RECIP_REQ_for_diff_iso_usage.diff_iso.tsv"
...
plot_isoform_umap = function(gene_of_interest, restrict_to_transcript_ids = NULL) {
  ...
  base_umap + geom_point(data=isoform_umap, aes(color=transcript_id), alpha=0.9) +
...
p_my_gene_of_interest = make_diff_iso_usage_compound_plot(my_gene_of_interest, 0.1, TRUE)
...
num_top_diff_iso_usage_plots = 300
top_diff_iso_usage_plots_dir <- paste0("top_", num_top_diff_iso_usage_plots, "_diff_iso_usage_plots_minIsoF0.1.TOP_ISO_RECIP")
...
test_gene = top_diff_iso_usage_genes[1]

test_gene = "GOPC^g:chr6:-:comp-229"

test_plot_info = get_expression_ggplot2_heatmap_w_exon_structures(test_gene, 0.5, ignore_unspliced=T)
test_plot_info$plot
...
p = make_diff_iso_usage_compound_plot(test_gene, MIN_DELTA_PI, ignore_unspliced = TRUE)
...
for(gene_sym_value in top_diff_iso_usage_genes) {
    ...
    tryCatch({
        ...
        p = make_diff_iso_usage_compound_plot(gene_sym_value, MIN_DELTA_PI, ignore_unspliced = TRUE)
