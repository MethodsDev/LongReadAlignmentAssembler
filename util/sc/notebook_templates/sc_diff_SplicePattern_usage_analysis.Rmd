...
transcript_ids_use = c(top_diff_iso_usage_genes$dominant_transcript_ids[1],
                       top_diff_iso_usage_genes$alternate_transcript_ids[1])


test_plot_info = get_expression_ggplot2_heatmap_w_exon_structures(test_gene, 0.2, 
                                                                  ignore_unspliced=F, 
